...
int main(int argc, char *argv[]){
    ...
    vector<string> X_names =  {"new_request_cnt", "swap_prob", "num_of_node", "entangle_alpha"};   // {"request_avg" , "memory_cnt_avg" , "new_request_cnt", "swap_prob", "num_of_node", "entangle_alpha",  "area_alpha" ,  "resource_ratio"};
    ...
    vector<string> algo_names = {"MyAlgo3_0.100000", "MyAlgo3_0.200000", "MyAlgo3_0.400000","MyAlgo3_0.600000", "MyAlgo3_0.800000"};//{"Greedy_Nonlimit","QCAST_Nonlimit","REPS_Nonlimit", "MyAlgo3"}; //{"Greedy_Nonlimit","QCAST_Nonlimit","REPS_Nonlimit", "MyAlgo3"}; //"MyAlgo", "MyGreedyAlgo", "MyAlgo2", 
    // init result
