...
int main(int argc, char *argv[]){
    ...
    vector<string> Y_names = { "throughputs", "use_channel_ratio",  "use_memory_ratio", "runtime","use_memory", "total_memory","use_channel", "total_channel" , "S_D_complete_ratio_difference", "path_success_avg" , "max_over_ratio"};
