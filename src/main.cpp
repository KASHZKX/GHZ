...
int main(int argc, char *argv[]){
    ...
    vector<string> algo_names = {"MyAlgo3_0.1", "MyAlgo3_0.2", "MyAlgo3_0.3","MyAlgo3_0.4"};//"Greedy_Nonlimit","QCAST_Nonlimit","REPS_Nonlimit", "MyAlgo3"}; //"MyAlgo", "MyGreedyAlgo", "MyAlgo2", 
    // init result
